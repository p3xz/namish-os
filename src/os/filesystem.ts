...
const legalBody = [
  'Legal Notice',
  '',
  '(c) 2026 Namish Yadav. All original content on this site is my own.',
  'Last updated: September 2026',
  '',
  ...
  'describe my own original work and my own experience building it. No claims are',
  'made about anyone else.',
  '',
  ...
  '  respective owners and are used only to describe my work (nominative use).',
  '',
  'How this site stays out of trouble:',
  '- Only original work is published here. No copied text, no hotlinked images,',
  '  no unlicensed assets.',
  '- No tracking: no analytics pixels, no advertising cookies, no third-party',
  '  trackers of any kind. See cookies.txt.',
  '- No personal data is collected, so there is nothing to leak or misuse.',
  '  See privacy.txt.',
  '- Content is provided as-is, with no warranties. See terms.txt.',
  '',
  'Takedown requests: if you believe anything here infringes your rights or',
  'misrepresents you, email nam4sh@gmail.com with the page and a description of',
  'the issue. Valid complaints are reviewed and fixed promptly, usually by',
  'removing or correcting the material.',
  '',
